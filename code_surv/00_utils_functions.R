...
# 1. SRS (Simple Random Sampling) List
data_info_srs <- list(
  weight_var = "W",
  cat_vars = c("SEX", "RACE", "SMOKE", "EXER", "ALC", "INSURANCE", "REGION", 
               ...
               "HYPERTENSION", "EVENT", "EVENT_STAR",
               # Categorical STAR variables
  ...
  num_vars = c("X", "ID", "AGE", "EDU", "HEIGHT", "BMI", "MED_Count",
               ...
               "SpO2", "WEIGHT", "C", "T_I",
               # Numeric STAR variables
               "EDU_STAR", "HEIGHT_STAR", "BMI_STAR", "SBP_STAR", "Triglyceride_STAR", "LDL_STAR",
               "Creatinine_STAR", "eGFR_STAR", "HbA1c_STAR", "F_Glucose_STAR", "Glucose_STAR", "Insulin_STAR",
  ...
  phase2_vars = c("SMOKE", "ALC", "EXER", "INCOME", "EDU", 
                  ...
                  "Creatinine", "eGFR", "BMI", "HEIGHT", "SBP", "Triglyceride", "LDL"),
  phase1_vars = c("SMOKE_STAR", "ALC_STAR", "EXER_STAR", "INCOME_STAR", "EDU_STAR", 
                  ...
                  "Creatinine_STAR", "eGFR_STAR", "BMI_STAR", "HEIGHT_STAR", "SBP_STAR", "Triglyceride_STAR", "LDL_STAR")
)

# 2. Balanced Sampling List (Includes STRATA)
data_info_balance <- list(
  ...
  cat_vars = c("SEX", "RACE", "SMOKE", "EXER", "ALC", "INSURANCE", "REGION", 
               ...
               "rs1111875", "rs4402960", "rs4607103", "rs7754840", "rs9300039",
               "rs5015480", "rs9465871", "rs4506565", "rs5219", "rs358806", 
               "HYPERTENSION", "EVENT", "EVENT_STAR", "STRATA",
               # Categorical STAR variables
               "SMOKE_STAR", "ALC_STAR", "EXER_STAR", "INCOME_STAR",
               "rs10811661_STAR", "rs7756992_STAR", "rs11708067_STAR", "rs17036101_STAR", "rs17584499_STAR",
               "rs1111875_STAR", "rs4402960_STAR", "rs4607103_STAR", "rs7754840_STAR", "rs9300039_STAR",
...
# 3. Neyman Allocation List (Identical structure to Balance)
