...
if(!dir.exists('./simulations/SRS/raking')){dir.create('./simulations/SRS/raking')}
...
for (i in 1:500){
  ...
  if (!file.exists(paste0("./simulations/SRS/raking/", digit, ".RData"))){
    rakingest <- calibrateFun(samp_srs, design = "SRS")
    save(rakingest, file = paste0("./simulations/SRS/raking/", digit, ".RData"))
  }
